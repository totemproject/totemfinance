        ...
        <footer className="footer" style={{zIndex: 0}}>
            <ul className="footer__links">
                <li>
                    <a
                        title="title"
                        href="https://medium.com/@totemfinance"
                        target="_blank"
                ...
                <li>
                    <a
                        title="title"
                        href="https://twitter.com/totemfinance"
                        target="_blank"
                        rel="noopener"
                    >
                        <svg width="30" height="30" viewBox="0 0 30 30">
                ...
                <li>
                    <a title="title" href="https://github.com/totemproject" target="_blank" rel="noopener">
                        <svg width="30" height="30" viewBox="0 0 30 30">
